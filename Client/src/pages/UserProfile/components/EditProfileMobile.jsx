...
function EditProfileMobile({ open, onClose, data, setNewProfile }) {
    ...
    return (
        <div className={`py-5 px-4 fixed inset-0 z-50 bg-white ${animateClass}`}>
            ...
            <div className="shadow-2xl w-full px-4 z-50 py-5 bg-white fixed left-0 bottom-0 flex justify-center items-center">
                <Button
                    onClick={handleSave}
                    fullWidth
                    variant="contained"
